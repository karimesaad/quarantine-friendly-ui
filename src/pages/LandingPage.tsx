...
//  2. get latitude and longitud from entered zip code (api call?)
...
//  4. from list of companies obtained, get latitude and longitud and call https://developers.google.com/maps/documentation/distance-matrix/ to obtain distances from entered zipcode 
